        ...
        <AppLayout>
            ...
            <div className="p-5 space-y-5">
                <div className="flex flex-col md:flex-row gap-5 w-full">
                    <div className="flex flex-col md:flex-row gap-5 w-full">
                        {/* Left Purple Card */}
                        <div className="flex-1 bg-linear-to-br from-indigo-500 to-purple-500 text-white rounded-xl p-8 relative overflow-hidden">
                        ...
                        <div className="flex items-center justify-around mt-6">
                            <div className="text-center">
                                <div className="flex items-center justify-center gap-2">
                                    <div className="p-2 bg-cyan-100 text-cyan-600 rounded-md">🛒</div>
                            ...
                            <div className="text-center">
                                <div className="flex items-center justify-center gap-2">
                                    <div className="p-2 bg-purple-100 text-purple-600 rounded-md">🔗</div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
                    ...
                    <div className="bg-white rounded-xl shadow p-8">
                        ...
                        <div className="flex items-end gap-6 mt-8 h-32">
                            {['h-12', 'h-16', 'h-20', 'h-14', 'h-28', 'h-18', 'h-14'].map(
                                (height, i) => (
